          ...
          <nav>
            <ul id="mobile_nav" class="hide_on_mobile">
              ...
              <li>
                ...
                <router-link :to="'/planets-fact/saturne'" class="nav_links">saturne<img class="hide_on_med_and_up icon_chevron" src="../assets/images/icon-chevron.svg" alt=""></router-link>
              </li>
              <li>
